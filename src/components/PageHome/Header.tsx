    ...
    <div className="container py-8 flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row md:justify-around md:items-center md:w-3/4">
        <p className="text-lg md:w-1/2 md:text-2xl">
          ...
          knowledge, learn from others, and discover new plant species that
          match your preferences. Join us and let's explore the wonderful world
          of plants together!
        </p>
        <img src={image} alt="" />
      </div>
