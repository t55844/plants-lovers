        ...
        <footer className="bg-lime-300 py-4">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex space-x-4">
                    <p className="text-gray-800 text-sm">&copy; {new Date().getFullYear()} Plant Lovers. All rights reserved.</p>
                </div>
            ...
            <div className="container mx-auto mt-4">
                <p className="text-sm text-gray-600">
                    Disclaimer: The information provided on this website is for general informational purposes only. It should not be considered as professional advice. Please consult with a plant expert before implementing any gardening practices or plant care tips mentioned here.
                </p>
            </div>
        </footer>
    );
